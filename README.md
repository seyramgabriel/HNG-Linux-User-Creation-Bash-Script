...
You can view the log file with this command
```cat /var/log/user_management.log```

### Run this command to output the content and verify the access permissions on /var/log/user_management.log
...
## Deeper Dive
I believe thus far, this write up has provided enough information for a high level documentation. But I woild like to dive a little deeper into the work of each block of code in the script, in case one wants to use it and must satisfy the demands of low level documentation. 
